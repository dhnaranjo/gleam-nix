...
in
{
  ...
  workspace = {
    gleam = rustPackages.unknown.gleam."0.28.2";
    gleam-core = rustPackages.unknown.gleam-core."0.28.2";
    gleam-wasm = rustPackages.unknown.gleam-wasm."0.28.2";
    test-package-compiler = rustPackages.unknown.test-package-compiler."0.28.2";
  };
  ...
  "unknown".gleam."0.28.2" = overridableMkRustCrate (profileName: rec {
    name = "gleam";
    version = "0.28.2";
    registry = "unknown";
    ...
    dependencies = {
      ...
      gleam_core = rustPackages."unknown".gleam-core."0.28.2" { inherit profileName; };
  ...
  "unknown".gleam-core."0.28.2" = overridableMkRustCrate (profileName: rec {
    name = "gleam-core";
    version = "0.28.2";
    registry = "unknown";
  ...
  "unknown".gleam-wasm."0.28.2" = overridableMkRustCrate (profileName: rec {
    name = "gleam-wasm";
    version = "0.28.2";
    registry = "unknown";
    ...
    devDependencies = {
      wasm_bindgen_test = rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-test."0.3.34" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hostname."0.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.141" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hyper."0.14.25" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      futures_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.28" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.28" { inherit profileName; };
      h2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".h2."0.3.17" { inherit profileName; };
      http = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mio."0.8.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "wasi" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.141" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.17" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "wasi" then "wasi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasi."0.11.0+wasi-snapshot-preview1" { inherit profileName; };
      ${ if hostPlatform.isWindows then "windows_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.45.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.16" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      futures_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.28" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.28" { inherit profileName; };
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "h2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".h2."0.3.17" { inherit profileName; };
      http = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.9" { inherit profileName; };
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.27.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ring."0.16.20" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.kernel.name == "android" || hostPlatform.parsed.kernel.name == "linux" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.141" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".syn."2.0.14" = overridableMkRustCrate (profileName: rec {
    ...
    version = "2.0.14";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fcf316d5356ed6847742d036f8a39c3b8435cac10bd528a4bd461928a6ab34d5"; };
    features = builtins.concatLists [
      [ "clone-impls" ]
      [ "default" ]
      [ "derive" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tempfile."3.5.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "wasi" then "rustix" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustix."0.37.11" { inherit profileName; };
      ${ if hostPlatform.isWindows then "windows_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.45.0" { inherit profileName; };
    };
  });
  ...
  "unknown".test-package-compiler."0.28.2" = overridableMkRustCrate (profileName: rec {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unicode-linebreak."0.1.4" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      regex = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.7.3" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-test."0.3.34" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      wasm_bindgen_test_macro = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-test-macro."0.3.34" { profileName = "__noProfile"; };
    };
  });
